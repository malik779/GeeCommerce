...
using Gee.Core.Enum;
    ...
    public class Product : BaseEntity<int, int, int>, IDiscountSupported<DiscountMapping>, ISoftDeletedEntity
    {
        /// <summary>
        ...
        /// </summary>
        public RentalGracePeriod RentalPricePeriod
        {
            get => (RentalGracePeriod)RentalPricePeriodId;
