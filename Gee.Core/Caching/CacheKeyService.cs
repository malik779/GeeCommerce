...
namespace Gee.Core.Caching
{
    public abstract partial class CacheKeyService : ICacheKeyService
    {
        ...
        protected readonly AppSettingConfig _appSettings;

        #endregion

        #region Ctor
      
        protected CacheKeyService(AppSettingConfig appSettings)
        {
        ...
        protected virtual object CreateCacheKeyParameters(object parameter)
        {
            return parameter switch
            {
                ...
                IEnumerable<BaseEntity<int, int, int>> entities => CreateIdsHash(entities.Select(entity => entity.Id)),
                BaseEntity<int, int, int> entity => entity.Id,
