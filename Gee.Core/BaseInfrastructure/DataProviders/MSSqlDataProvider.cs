...
{
    public partial class MSSqlDataProvider<TContext> : BaseDataProvider<TContext>, IBaseDataProvider where TContext : DbContext
    {
      
        public MSSqlDataProvider(TContext _dbContext) : base(_dbContext)
        {
        }
        #region Utilities
        ...
        public override IQueryable<TEntity> GetTable<TEntity>()
        {
            ...
            var TableLink2=(ITable<TEntity>)base.GetTable<TEntity>();
            return DataSettingsManager.UseNoLock() ? TableLink2?.With("NOLOCK") : TableLink2;
        }
        ...
        /// </returns>
        public virtual Task<int?> GetTableIdentAsync<TEntity>() where TEntity : BaseEntity<int, int, int>
        {
        ...
        public virtual async Task SetTableIdentAsync<TEntity>(int ident) where TEntity : BaseEntity<int, int, int>
        {
            using var currentConnection = CreateDataConnection();
