...
{
    public partial interface IBaseDataProvider
    {
        ...
        /// <typeparam name="TItem">Storage record mapping BaseEntity<int,int,int></typeparam>
        /// <returns>
        ...
        /// </returns>
        Task<TEntity> InsertEntityAsync<TEntity>(TEntity entity) where TEntity : BaseEntity<int,int,int>;
        ...
        TEntity InsertEntity<TEntity>(TEntity entity) where TEntity : BaseEntity<int,int,int>;
        ...
        Task UpdateEntityAsync<TEntity>(TEntity entity) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <param name="entity">Entity with data to update</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        void UpdateEntity<TEntity>(TEntity entity) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task UpdateEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <param name="entities">Entities with data to update</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        void UpdateEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteEntityAsync<TEntity>(TEntity entity) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <param name="entity">Entity for delete operation</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        void DeleteEntity<TEntity>(TEntity entity) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task BulkDeleteEntitiesAsync<TEntity>(IList<TEntity> entities) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <param name="entities">Entities for delete operation</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        void BulkDeleteEntities<TEntity>(IList<TEntity> entities) where TEntity : BaseEntity<int,int,int>;
        ...
        /// </returns>
        Task<int> BulkDeleteEntitiesAsync<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : BaseEntity<int,int,int>;
        ...
        /// </returns>
        int BulkDeleteEntities<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task BulkInsertEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <param name="entities">Collection of Entities</param>
        void BulkInsertEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseEntity<int,int,int>;
        ...
        /// <summary>
        /// Returns queryable source for specified mapping BaseEntity<int,int,int> for current connection,
        /// mapped to database table or view.
        /// </summary>
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>Queryable source</returns>
        IQueryable<TEntity> GetTable<TEntity>() where TEntity : BaseEntity<int,int,int>;
        ...
        /// </returns>
        Task<int?> GetTableIdentAsync<TEntity>() where TEntity : BaseEntity<int,int,int>;
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SetTableIdentAsync<TEntity>(int ident) where TEntity : BaseEntity<int,int,int>;
        ...
        Task TruncateAsync<TEntity>(bool resetIdentity = false) where TEntity : BaseEntity<int,int,int>;
