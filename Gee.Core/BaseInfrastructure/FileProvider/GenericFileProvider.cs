...
namespace Gee.Core.BaseInfrastructure.FileProvider
{
    ...
    public partial class GenericFileProvider(IHostEnvironment webHostEnvironment) : PhysicalFileProvider(File.Exists(webHostEnvironment.ContentRootPath) ? Path.GetDirectoryName(webHostEnvironment.ContentRootPath)! : webHostEnvironment.ContentRootPath), IGenericFileProvider
    {
        ...
        /// </summary>
        public string WebRootPath { get; } = File.Exists(webHostEnvironment.ContentRootPath)
                ? Path.GetDirectoryName(webHostEnvironment.ContentRootPath)
                : webHostEnvironment.ContentRootPath;
        public IHostEnvironment WebHostEnvironment { get; } = webHostEnvironment;
