...
namespace Gee.Core.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity<int,int,int> entity) where TModel : BaseEntityModel<int,int,int>
        {
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity<int,int,int> where TModel : BaseEntityModel<int,int,int>
        {
            ArgumentNullException.ThrowIfNull(entity);
        ...
        public static TEntity ToEntity<TEntity>(this BaseEntityModel<int,int,int> model) where TEntity : BaseEntity<int,int,int>
        {
            ArgumentNullException.ThrowIfNull(model);
        ...
        ///// <returns>Mapped model</returns>
        //public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseEntity<int,int,int>, ISettingsModel
        //{
        ...
        //    where TSettings : class, ISettings where TModel : BaseEntity<int,int,int>, ISettingsModel
        //{
        //    ArgumentNullException.ThrowIfNull(model);
        ...
        /// <returns>Mapped model</returns>
        //public static TModel ToConfigModel<TModel>(this IConfig config) where TModel : BaseEntity<int, int, int>, IConfigModel
        //{
        ...
        //    where TConfig : class, IConfig where TModel : BaseEntity<int, int, int>, IConfigModel
        //{
        //    ArgumentNullException.ThrowIfNull(model);
        ...
        ///// <returns>Mapped model</returns>
        //public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseEntity<int,int,int>, IPluginModel
        //{
        ...
        //    where TModel : BaseEntity<int,int,int>, IPluginModel
        //{
